...
# Working Nifty Email Configuration
EMAIL_HOST = 'mail.nifty.co.tz'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'events@nifty.co.tz'
EMAIL_HOST_PASSWORD = '+RI=T{h81M$5'
DEFAULT_FROM_EMAIL = 'events@nifty.co.tz'
EMAIL_TIMEOUT = 30
